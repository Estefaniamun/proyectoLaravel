                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <button type="button" data-modal-target="popup-modal"
                                                data-modal-toggle="popup-modal{{ $producto->id }}"
                                            ...
                                            <div id="popup-modal{{ $producto->id }}" tabindex="-1"

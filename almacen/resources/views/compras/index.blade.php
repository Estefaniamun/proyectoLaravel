                                ...
                                @foreach ($compras as $compra)
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <a href="{{ route('compra.edit', ['id' => $compra->id]) }}">
                                                <button type="button"
                                            ...
                                            <button type="button" data-modal-target="popup-modal"
                                                data-modal-toggle="popup-modal{{ $compra->id }}"
                                            ...
                                            <div id="popup-modal{{ $compra->id }}" tabindex="-1"
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        ...
                                                        <div class="p-6 text-center">
                                                            ...
                                                            <h3
                                                                ...
                                                                ¿Estas seguro de que deseas eliminar esta compra?</h3>
                                                            <form
                                                                action="{{ route('compra.destroy', ['id' => $compra->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('delete')
                                                                <button
                                                                    data-modal-hide="popup-modal{{ $compra->id }}"
                                                                    type="submit"
                                                                    class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                                   Si, quiero borrarlo
                                                                </button>
                                                            </form>
                                                            <button data-modal-hide="popup-modal{{ $compra->id }}"
                                                                type="submit"
                                                                class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600"><a
                                                                    href="{{ route('compra.index') }}">No,
                                                                    Cancelar</a></button>
                                                        </div>
                                                    </div>
                                                </div>
